...
var Game = function (_Phaser$Game) {
	...
	function Game() {
		...
		var width = (0, _utils.getSize)()[0];
		var height = (0, _utils.getSize)()[1];
...
},{"./utils":8,"states/GameState":7}],3:[function(require,module,exports){
"use strict";
...
var Ant = function (_Phaser$Sprite) {
  ...
  function Ant(game, x, y) {
    var antColor = arguments.length <= 3 || arguments[3] === undefined ? _constants.AntsColor[0] : arguments[3];
...
var Cell = function (_Phaser$Graphics) {
  ...
  function Cell(game, x, y, width, height) {
    var color = arguments.length <= 5 || arguments[5] === undefined ? 0xFFFFFFF : arguments[5];
    var lineColor = arguments.length <= 6 || arguments[6] === undefined ? 0x000000 : arguments[6];
...
var GameState = function (_Phaser$State) {
  ...
  _createClass(GameState, [{
    ...
    key: 'setAntCenter',
    value: function setAntCenter(Bounds) {
...
},{"../constants":1,"../utils":8,"objects/Ant":3,"objects/Grid":5,"objects/History":6}],8:[function(require,module,exports){
"use strict";
...
function getSize() {
  if (!window.gridSize) {
    return [_constants.WidthCanvas, _constants.HeighCanvas];
  }

  var sizeT = window.gridSize;
  var bounds = _constants.CellWidth * sizeT;
  var width = bounds;
  var height = bounds;

  if (bounds > _constants.WidthCanvas) {
    width = _constants.WidthCanvas;
  }
  if (bounds > _constants.HeighCanvas) {
    height = _constants.HeighCanvas;
  }
  return [width, height];
}
